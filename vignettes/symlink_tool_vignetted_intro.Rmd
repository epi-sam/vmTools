...
The most important thing you get are some simple logs, that auto-magically keep track of which folders have been 'best.'

1. Maintain a central log of which versions of your pipeline have ever been 'best'.
    1. Allows you to keep older versions around for a while in case you need to 'roll back' what you consider 'best'.
    1. Track deletion of old pipeline runs.
1. Maintain run-specific log of 'best' promotions & demotions within each versioned output folder.
    1. Run reports for your Project Officer on the state of all your important pipeline outputs.  
...
That's very true.  But maybe there are folders you want to track for different reasons.  
...
1. Mark folders as 'keep', with a symlink that tells you it's important.
    1. You get all the same log and report benefits as the 'best' symlink.



> OK, this sounds pretty nice, but didn't you also say something about deleting folders?  Why do I need help doing that?
...
1. Let you mark folders you want to 'remove' **before** you actually delete them.
    1. This is a 'staging area' where you can take time to decide before you actually remove them.
    1. You can also 'unmark' them for removal if you change your mind.
1. When you want to really delete them:
    1. You'll get a warning if you try to delete a folder that isn't marked for removal (safety).
    1. You'll get a line in the central log so you know what happened in the future (provenance).
